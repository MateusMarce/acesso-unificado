                ...
                <div className="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                    ...
                    <div className="app-container container-xxl d-flex flex-row flex-column-fluid">
                        <div className="app-main flex-column flex-row-fluid" id="kt_app_main">
                            ...
                            <div className="row">
                                {!show && !no && dados.retorno == 1 &&
                                    <div className="card card-body py-7 m-auto d-flex justify-content-center flex-column gap-4 mw-750px w-100">
                                        <h3 className="text-center">Você é ex-aluno da SATC?</h3>
                                        <div className="d-flex gap-4 justify-content-center">
                                            <button onClick={()=>setShow(true)} className="btn btn-success">Sim</button>
                                            <button onClick={()=>setNo(true)} className="btn btn-secondary">Não</button>
                                        </div>
                                    </div>
                                }
                                {no && 
                                    <div className="card card-body m-auto mw-750px w-100 d-flex justify-content-center align-items-center">
                                        <i className="bi bi-exclamation-circle mb-5 text-gray-600" style={{fontSize:50}}></i>
                                        <h4>Este campo é destinado exclusivamente para egressos da SATC.</h4>
                                    </div>
                                }
                                {show &&
                                    <>
