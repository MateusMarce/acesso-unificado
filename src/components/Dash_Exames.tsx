    ...
    return (
		<div className="h-100 py-10 d-flex align-items-center justify-content-center">
			<div className="p-10 rounded-3 row w-50">
				...
				<textarea onChange={(t)=>setAnotacoes(t.currentTarget.value)} cols={12} maxLength={225} style={{resize:"none"}} className="form-control form-control-lg bg-transparent mb-4 mt-3" placeholder="Anotações de agendamento" />
