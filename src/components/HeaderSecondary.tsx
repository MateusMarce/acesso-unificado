                    ...
                    <div className="w-100 d-flex flex-stack">
                        <div className="d-flex flex-stack me-5">
                            ...
                            <div className="d-flex gap-1 gap-lg-2">
                                ...
                                <a href='https://fs.alunosatc.edu.br/adfs/ls/?cbcxt=&popupui=&vv=&mkt=&lc=1046&wfresh=&wa=wsignin1.0&wtrealm=urn:federation:MicrosoftOnline&wctx=wa%3Dwsignin1.0%26rpsnv%3D4%26ct%3D1422017220%26rver%3D6.4.6456.0%26wp%3DMCMBI%26wreply%3Dhttps:%252F%252Fportal.office.com%252Flanding.aspx%253Ftarget%253D%25252fdefault.aspx%26lc%3D1046%26id%3D501392%26bk%3D1422017219%26LoginOptions%3D3' target={'_blank'} className="custom-link rounded px-lg-4 py-lg-2 d-flex flex-center cursor-pointer">
                                    <img src={EmailSvg} className="w-20px" alt="" />
                                    <span className="d-none d-lg-inline text-gray-600 fw-bold text-hover-primary fs-5 ps-3">E-mail Aluno SATC</span>
                                </a>
