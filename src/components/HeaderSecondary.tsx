...
import Dash_ModalRamal from './Dash_ModalRamal'
                    ...
                    <div className="w-100 d-flex flex-stack">
                        <div className="d-flex flex-stack me-5">
                            ...
                            <div className="d-flex gap-1 gap-lg-2">
                                <a className="custom-link rounded px-lg-4 py-lg-2 d-flex flex-center cursor-pointer" data-bs-toggle="modal" data-bs-target="#modalRamal">
